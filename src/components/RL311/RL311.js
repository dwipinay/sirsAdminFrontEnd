    ...
    const Cari = async (e) => {
        ...
        if (idrs != "") {
            try {
                ...
                const results = await axiosJWT.get('/apisirs/rltigatitiksebelasadmin',
                    customConfig)
                ...
                <div className="col-md-6">
                    <div className="card">
                        <div className="card-body">
                            <h5 className="card-title h5">Validasi RL 3.11</h5>
                            ...
                            {dataRL.map((value, index) => {
                                return (
                                    <tr key={value.id}>
                                        ...
                                        <td><label htmlFor="">{value.jenis_pelayanan.no}</label> </td>
                                        <td><label htmlFor="">{value.jenis_pelayanan.nama}</label></td>
                                        <td><label htmlFor="">{value.jumlah}</label></td>

  ...
  const Cari = async (e) => {
    ...
    if (idrs !== "") {
      try {
        ...
        setNamaFile("RL33_" + idrs);
        setSpinner(false);
        setNamaRS(results.data.dataRS.RUMAH_SAKIT);
        if (kategoriUser === 3 && dataRLTigaTitikTigaDetails.length > 0) {
          setButtonStatus(false);
        } else if (
          kategoriUser === 3 &&
          dataRLTigaTitikTigaDetails.length === 0
        ) {
          setButtonStatus(true);
        }
        // setKabKota(results.)
    ...
    <div className="container" style={{ marginTop: "70px" }}>
      <div className="row">
        <div className="col-md-6">
          <div className="card">
            <div className="card-body">
              <h5 className="card-title h5">Validasi RL 3.3 Gigi dan Mulut</h5>
        ...
        <div className="col-md-6">
          <div className="card">
            <div className="card-body">
              <h5 className="card-title h5">Filter RL 3.3 Gigi dan Mulut</h5>
              <form onSubmit={Cari}>
